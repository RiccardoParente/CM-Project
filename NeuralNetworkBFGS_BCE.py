...
class NeuralNetworkBFGS_BCE(NeuralNetwork):
    ...
    def line_search_wolfe(self, p_k, grad_f_k, X_train, y_train, t, T, c1=1e-4, c2=0.9, max_alpha=1.0):
        ...
        for i in range(20):
            ...
            phi_i = self.loss.compute(self.predicted_output, y_train) + self.regularization*np.linalg.norm(params_temp)
    ...
    def train(self, X_train, y_train, epochs=100, tol=1e-8):
        params = self.flatten_params()
